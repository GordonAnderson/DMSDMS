...
// FAIMSFB commands
  {"SFBENA",  CMDfunctionStr, 2, (char *)setEnable},                      // Set to TRUE to enable FAIMS
  {"GFBENA",  CMDfunction, 1, (char *)getEnable},                         // Returns enable status
#if FIRMWARE == WAVEFORMS
  {"SFBMODE",  CMDfunctionStr, 2, (char *)setMode},                       // Set to TRUE to enable closed loop control of Vrf
  {"GFBMODE",  CMDfunction, 1, (char *)getMode},                          // Returns mode control
  {"SFBFREQ", CMDfunction,  2, (char *)setFreq},                          // Set FAIMS frequency, in Hz
  {"GFBFREQ", CMDfunction,  1, (char *)getFreq},                          // Returns frequency
  {"SFBDUTY", CMDfunction,  2, (char *)setDuty},                          // Set FAIMS duty cycle in percent
  {"GFBDUTY", CMDfunction,  1, (char *)getDuty},                          // Returns duty cycle
  {"SFBDRV", CMDfunctionStr,  2, (char *)setDrive},                       // Set FAIMS drive level in percent
  {"GFBDRV", CMDfunction,  1, (char *)getDrive},                          // Returns drive level
  {"GDRVV", CMDfunction,  1, (char *)getDriveV},                          // Returns voltage level into drive FET, V
  {"GDRVI", CMDfunction,  1, (char *)getDriveI},                          // Returns current into drive FET, mA
  {"SVRF", CMDfunctionStr,  2, (char *)setVrfCmd},                        // Sets the drive level to achieve the desired voltage
  {"SVRFF", CMDfunctionStr,  2, (char *)setVrfTableCmd},                  // Sets the drive level using the look up table
  {"GVRF", CMDfunction,  1, (char *)getVrf},                              // Returns the Vrf peak voltage
  {"GVRFV", CMDfunction,  1, (char *)getVrfRB},                           // Returns the actual Vrf peak voltage
  {"GPWR", CMDfunction,  1, (char *)getPower},                            // Returns the power in watts
// FAIMSFB Limits
  {"SFBMAXDRV",  CMDfunctionStr, 2, (char *)setMaxDrive},                 // Set the maximum drive level allowed
  {"GFBMAXDRV",  CMDfunction, 1, (char *)getMaxDrive},                    // Returns the maximum drive level
  {"SFBMAXPWR",  CMDfunctionStr, 2, (char *)setMaxPower},                 // Set the maximum power allowed
  {"GFBMAXPWR",  CMDfunction, 1, (char *)getMaxPower},                    // Returns the maximum power limitl
  {"SGAIN", CMDfunctionStr, 2, (char *)setLoopGain}, 
  {"GGAIN", CMDfunction, 1, (char *)getLoopGain}, 
// FAIMS calibration commands
  {"CALVRF", CMDfunction, 1, (char *)calVrf}, 
  {"CALDRV2VRF", CMDfunction, 1, (char *)calVrf2Drive}, 
  {"CALCUR", CMDfunction, 1, (char *)calCurrent}, 
#endif
#if FIRMWARE == CVBIAS
// DC bias commands
  {"SCV", CMDfunctionStr,     2, (char *)setCV},  
  {"GCV", CMDfunction,        1, (char *)getCV},  
  {"GCVV",CMDfunction,        1, (char *)getCVV},  
  {"SBIAS", CMDfunctionStr,   2, (char *)setBias},  
  {"GBIAS", CMDfunction,      1, (char *)getBias},  
  {"GBIASV",CMDfunction,      1, (char *)getBiasV},
// FAIMS CV scanning commands
  {"SFBCVSTRT", CMDfunctionStr, 2, (char *)setCVstart},                  // set the CV scan start voltage
  {"GFBCVSTRT", CMDfunction,    1, (char *)getCVstart},                  // returns the CV scan start voltage
  {"SFBCVEND",  CMDfunctionStr, 2, (char *)setCVend},                    // set the CV scan end voltage
  {"GFBCVEND",  CMDfunction,    1, (char *)getCVend},                    // returns the CV scan end voltage
  {"SFBSTEPDUR",CMDfunctionStr, 1, (char *)setStepDuration},             // set the scan step duration in mS
  {"GFBSTEPDUR",CMDint,         0, (char *)&dmsdata.StepDuration},       // returns the scan step duration in mS
  {"SFBNUMSTP", CMDfunction,    1, (char *)setSteps},                    // set the scan number of steps
  {"GFBNUMSTP", CMDint,         0, (char *)&dmsdata.Steps},              // returns the scan number of steps
  ...
  {"SFBEXTSTP", CMDfunctionStr, 1, (char *)setEnableExtStep},            // Set to TRUE to enable external pin rising edge to advance step
  {"GFBEXTSTP", CMDbool,        0, (char *)&dmsdata.EnableExtStep},      // Returns enable external pin status
  {"SFBSTPPIN", CMDfunction,    1, (char *)setExtAdvInput},              // Set pin number to use for external step input
  {"GFBSTPPIN", CMDint,         0, (char *)&dmsdata.ExtAdvInput},        // Returns pin number used for external step input
...
// FAIMS CV and BIAS calibration commands
  {"CALDCBREF", CMDfunction,0, (char *)CalibrateREF}, 
  {"CALDCBA1", CMDfunction, 0, (char *)CalibrateDCBA1}, 
  {"CALDCBB1", CMDfunction, 0, (char *)CalibrateDCBB1}, 
  {"CALDCBA2", CMDfunction, 0, (char *)CalibrateDCBA2}, 
  {"CALDCBB2", CMDfunction, 0, (char *)CalibrateDCBB2}, 
#endif
  // End of table marker
  {0},
};
